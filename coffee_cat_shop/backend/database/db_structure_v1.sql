...
--
-- Host: 127.0.0.1    Database: genz_fashion
-- ------------------------------------------------------
...
CREATE TABLE `order_details` (
  ...
  `productId` int NOT NULL,
  `fullname` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `products` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL,
  `brand` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `initialPrice` decimal(10,2) NOT NULL,
  `salePrice` decimal(10,2) DEFAULT NULL,
  `gender` tinyint(1) DEFAULT '2',
  `size` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `color` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
...
-- Dump completed on 2024-05-17 11:44:44
